...
public class EntityVioliumGolem extends EntityGolem
{
	protected static final DataParameter<Byte> PLAYER_CREATED = EntityDataManager.<Byte>createKey(EntityVioliumGolem.class, DataSerializers.BYTE);
    ...
    public EntityVioliumGolem(World worldIn)
    {
        super(worldIn);
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityVioliumGolem.class);
    }
    ...
    {
    	return LootTablesInit.ENTITIES_VIOLIUM_GOLEM;
    }
