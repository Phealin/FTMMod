...
import phealin.mod.entity.ai.EntityAIModdedDefendVillage;
import phealin.mod.entity.ai.EntityAIModdedLookAtVillager;
import phealin.mod.init.ItemInit;
import phealin.mod.init.LootTablesInit;
import phealin.mod.util.Reference;

public class EntityPurporiumGolem extends EntityGolem
{
	//public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/purporium_golem");
	
	protected static final DataParameter<Byte> PLAYER_CREATED = EntityDataManager.<Byte>createKey(EntityPurporiumGolem.class, DataSerializers.BYTE);
    ...
    public EntityPurporiumGolem(World worldIn)
    {
        super(worldIn);
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityPurporiumGolem.class);
    }
    ...
    {
        return LootTablesInit.ENTITIES_PURPORIUM_GOLEM;
    }
